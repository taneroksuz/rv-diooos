...
module eu (
  ...
  assign eu_out.agu0_in.load = 1'b0;
  assign eu_out.agu0_in.store = 1'b0;
  ...
  assign eu_out.agu1_in.load = 1'b0;
  assign eu_out.agu1_in.store = 1'b0;
  assign eu_out.agu1_in.lsu_op = init_lsu_op;

  assign eu_out.agu2_in.rdata1 = eu_in.mem_issue0.rdata1;
  assign eu_out.agu2_in.imm = eu_in.mem_issue0.imm;
  assign eu_out.agu2_in.pc = eu_in.mem_issue0.pc;
  assign eu_out.agu2_in.auipc = 1'b0;
  assign eu_out.agu2_in.jal = 1'b0;
  assign eu_out.agu2_in.jalr = 1'b0;
  assign eu_out.agu2_in.branch = 1'b0;
  assign eu_out.agu2_in.load = eu_in.mem_issue0.op.load;
  assign eu_out.agu2_in.store = 1'b0;
  assign eu_out.agu2_in.lsu_op = eu_in.mem_issue0.lsu_op;

  assign eu_out.agu3_in.rdata1 = eu_in.mem_issue0.rdata1;
  assign eu_out.agu3_in.imm = eu_in.mem_issue0.imm;
  assign eu_out.agu3_in.pc = eu_in.mem_issue0.pc;
  assign eu_out.agu3_in.auipc = 1'b0;
  assign eu_out.agu3_in.jal = 1'b0;
  assign eu_out.agu3_in.jalr = 1'b0;
  assign eu_out.agu3_in.branch = 1'b0;
  assign eu_out.agu3_in.load = 1'b0;
  assign eu_out.agu3_in.store = eu_in.mem_issue0.op.store;
  assign eu_out.agu3_in.lsu_op = eu_in.mem_issue0.lsu_op;
  ...
  assign eu_out.mul_in.rdata1 = eu_in.int_issue0.op.mult ? eu_in.int_issue0.rdata1
                                                          : eu_in.int_issue1.rdata1;
  assign eu_out.mul_in.rdata2 = eu_in.int_issue0.op.mult ? eu_in.int_issue0.rdata2
                                                          : eu_in.int_issue1.rdata2;
  assign eu_out.mul_in.mul_op = eu_in.int_issue0.op.mult ? eu_in.int_issue0.mul_op
                                                          : eu_in.int_issue1.mul_op;

  assign eu_out.div_in.rdata1 = eu_in.int_issue0.op.division ? eu_in.int_issue0.rdata1
                                                              : eu_in.int_issue1.rdata1;
  assign eu_out.div_in.rdata2 = eu_in.int_issue0.op.division ? eu_in.int_issue0.rdata2
                                                              : eu_in.int_issue1.rdata2;
  assign eu_out.div_in.div_op = eu_in.int_issue0.op.division ? eu_in.int_issue0.div_op
  ...
  assign eu_out.bit_clmul_in.rdata1 = eu_in.int_issue0.op.bitc ? eu_in.int_issue0.rdata1
                                                                 : eu_in.int_issue1.rdata1;
  assign eu_out.bit_clmul_in.rdata2 = eu_in.int_issue0.op.bitc ? eu_in.int_issue0.rdata2
                                                                 : eu_in.int_issue1.rdata2;
  ...
  assign eu_out.csr_alu_in.rdata1 = eu_in.int_issue0.op.csreg ? eu_in.int_issue0.rdata1
                                                               : eu_in.int_issue1.rdata1;
  assign eu_out.csr_alu_in.imm    = eu_in.int_issue0.op.csreg ? eu_in.int_issue0.imm
                                                               : eu_in.int_issue1.imm;
  ...
  assign eu_out.csr_alu_in.csr_op = eu_in.int_issue0.op.csreg ? eu_in.int_issue0.csr_op
