...
module rename (
  ...
  assign rs0_ok = rename_in.instr0_valid ? (i0_is_mem ? !rename_in.rs_mem_full : !rename_in.rs_int_full) : 1;
  assign rs1_ok = rename_in.instr1_valid ? (i1_is_mem ? rename_in.rs_mem_has_two : rename_in.rs_int_has_two) : 1;
  ...
  assign pdest1 = need_fl1 ? (need_fl0 ? rename_in.fl.alloc_tag1 : rename_in.fl.alloc_tag0) : PRF_ADDR_BITS'(0);
  ...
  assign rename_out.fl.free_en0 = 0;
  assign rename_out.fl.free_tag1 = '0;
  assign rename_out.fl.free_en1 = 0;
