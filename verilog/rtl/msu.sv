...
module msu (
  ...
  always_comb begin
    ...
    v.dmem1_in.mem_valid = load_enable;
  ...
  always_ff @(posedge clock) begin
    if (reset == 0) begin
      ...
      r.cdb        <= init_cdb;
      r.rob_wentry <= init_rob_entry;
      r.rob_wen    <= 1'b0;
      r.dmem1_in   <= init_mem_in;
    end else begin
      r <= rin;
    end
  end
