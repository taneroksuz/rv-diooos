package wires;
  ...
  localparam rob_reg_type init_rob_reg = '{array : '0, head : '0, tail : '0, count : '0};
  ...
  localparam rs_int_reg_type init_rs_int_reg = '{array : '0, count : '0};
  ...
  localparam rs_mem_reg_type init_rs_mem_reg = '{array : '0, count : '0};
