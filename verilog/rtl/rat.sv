...
module rat (
 ...
 rat_in.waddr0_p
  ...
  assign rat_out.psrc0_valid = spec_valid(rat_in.rsrc0_a);
  assign rat_out.psrc1 = spec_tag(rat_in.rsrc1_a);
  assign rat_out.psrc1_valid = spec_valid(rat_in.rsrc1_a);
  always_comb begin
    if (rat_in.wren0 && rat_in.rsrc2_a == rat_in.waddr0_a && rat_in.waddr0_a != 5'h0) begin
      ...
      rat_out.psrc2       = spec_tag(rat_in.rsrc2_a);
      rat_out.psrc2_valid = spec_valid(rat_in.rsrc2_a);
    end
    if (rat_in.wren0 && rat_in.rsrc3_a == rat_in.waddr0_a && rat_in.waddr0_a != 5'h0) begin
      ...
      rat_out.psrc3       = spec_tag(rat_in.rsrc3_a);
      rat_out.psrc3_valid = spec_valid(rat_in.rsrc3_a);
    end
  end
endmodule
